...
public class giris extends javax.swing.JFrame {
    ...
    public giris() {
        ...
        jButton2.setText("YENİ KULLANICI");
    ...
    private void initComponents() {
        ...
        jTabbedPane1.addTab("KULLANICI GİRİŞİ", jPanel1);
        ...
        jTabbedPane1.addTab("ADMİN GİRİŞ", jPanel2);
    ...
    islem3.baglantiac();
        String sorgu="SELECT * FROM `kutuphane`.`uyeler` WHERE tc_no=? and sifre=?;";
      try {

islem3.psd=islem3.baglanti.prepareStatement(sorgu); 
islem3.psd.setString(1, jTextField1.getText());
islem3.psd.setString(2, jPasswordField1.getText()); 
islem3.gelenveri=islem3.psd.executeQuery(); 
if(islem3.gelenveri.next())
{
int id= (Integer) islem3.gelenveri.getObject(1);
String ad= (String) islem3.gelenveri.getObject(2); 
JOptionPane.showMessageDialog(null,"Kütüphaneye Hoşgeldiniz :) "); 
islem3.baglantikapat();

 kitaplar f =new kitaplar();
        f.show();
        this.hide();
}
else{
...
JOptionPane.showConfirmDialog(null, "sorgu da hata var ");
    ...
    islem1.baglantiac();
        String sorgu="SELECT * FROM `kutuphane`.`uyeler` WHERE ad_soyad=? and sifre=?;";
      try {

islem1.psd=islem1.baglanti.prepareStatement(sorgu); 
islem1.psd.setString(1, jTextField2.getText());
islem1.psd.setString(2, jPasswordField2.getText()); 
islem1.gelenveri=islem1.psd.executeQuery(); 
if(islem1.gelenveri.next())
{
int id= (Integer) islem1.gelenveri.getObject(1);
String ad= (String) islem1.gelenveri.getObject(2); 
JOptionPane.showMessageDialog(null,"Kütüphaneye Hoşgeldiniz :) "); 
